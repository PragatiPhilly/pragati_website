...
beforeAll(async () => {
  ...
  CREATE TABLE IF NOT EXISTS promo_codes (id text PRIMARY KEY, event_id text, code text NOT NULL, discount_type text NOT NULL, discount_value integer NOT NULL, max_uses_total integer, max_uses_per_member integer DEFAULT 1, current_uses integer NOT NULL DEFAULT 0, valid_from timestamptz, valid_until timestamptz, created_by text, created_at timestamptz NOT NULL DEFAULT now());
