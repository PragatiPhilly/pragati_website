    ...
    <div className="relative">
      ...
      <section id="hero" className="relative overflow-hidden">
        ...
        {[
          ...
          <span
            key={i}
            className={`petal-drop ${p.cls}`}
            style={{ left: p.left, animationDelay: p.d }}
            aria-hidden
          />
        ))}
        {theme === 'durga' && (
          ...
          <div>
            <Reveal>
              ...
              >
                ...
                />
                <span className="font-[family-name:var(--font-bangla)] normal-case tracking-normal text-sm">
                  ১৯৭২ থেকে
                </span>
            ...
            <Reveal delay={0.08}>
              <h1 className="font-[family-name:var(--font-display)] text-5xl md:text-[56px] font-black leading-[1.04] tracking-tight">
                <span
                  className="font-[family-name:var(--font-bangla)] block text-xl md:text-2xl font-normal mb-3"
                  style={{ color: 'var(--terracotta)' }}
                >
                  আলো জ্বেলে যাও, ঐতিহ্যে ভাসো
                </span>
                Where the <span style={{ color: 'var(--sindoor)' }}>dhaak</span>{' '}
                beats,
                <br />
                and home{' '}
                <em
            ...
            <Reveal delay={0.16}>
              ...
              >
                Three days of light. A thousand familiar faces. Bengali
                Philadelphia, lit up like a village courtyard at Pujo — Pragati
                has been bringing this home since {site.foundedYear}.
              </p>
            </Reveal>
            <Reveal delay={0.24}>
          ...
          <Reveal delay={0.2}>
            ...
            {featured && (
              <div className="text-center mt-5">
                ...
                <p
                  className="font-[family-name:var(--font-bangla)] text-xl mt-1"
                  style={{ color: 'var(--sindoor)' }}
                >
                  {featured.nameBengali}
                </p>
                <p className="font-[family-name:var(--font-serif)] text-2xl font-semibold leading-tight">
                  {featured.name}
                </p>
              </div>
            )}
      ...
      <section
        id="lineup"
        className="mx-auto max-w-6xl px-5 pt-16 pb-12 scroll-mt-20"
      >
        <Reveal>
          <div className="text-center mb-12">
            <Eyebrow
              bn="উৎসবের মঞ্চ"
              en="Pujo weekend · live on stage"
              center
            />
            <h2 className="font-[family-name:var(--font-display)] text-3xl md:text-5xl font-black leading-tight">
              ...
              Two nights. Two{' '}
              <em style={{ color: 'var(--sindoor)' }}>legends</em>.
            </h2>
          </div>
        </Reveal>
          ...
          <>
            ...
            {concertPasses.length > 0 && active && (
              <div className="mt-7 flex flex-wrap justify-center gap-3">
                {concertPasses.map((c) => {
                  const day = Array.isArray(c.dayKeys)
                    ? (c.dayKeys as string[])[0]
                    : undefined;
                  const price =
      ...
      <section className="mx-auto max-w-6xl px-5 py-10 grid md:grid-cols-[1fr_1.1fr] gap-14 items-center">
        <Reveal>
          {slideshowPhotos.length > 0 ? (
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(165deg, var(--bg-soft) 0%, var(--marigold-pale) 100%)',
        ...
        <Reveal delay={0.12}>
          ...
          <h2 className="font-[family-name:var(--font-display)] text-3xl md:text-[42px] font-black leading-tight">
            ...
            <em style={{ color: 'var(--sindoor)' }}>culture</em>, compassion,
            and continuity.
          </h2>
          <blockquote
            className="my-6 pl-5 py-1 border-l-[3px]"
            style={{ borderColor: 'var(--marigold)' }}
          >
            <p
              className="font-[family-name:var(--font-bangla)] text-lg"
              style={{ color: 'var(--sindoor)' }}
            >
              &ldquo;যেখানে দশভুজার আশীর্বাদ, সেখানেই আমাদের বাড়ি।&rdquo;
            </p>
            <p
              className="font-[family-name:var(--font-serif)] italic mt-1"
              style={{ color: 'var(--ink-soft)' }}
            >
              &ldquo;Where Maa Durga&apos;s blessing dwells, there we make our
              home.&rdquo;
            </p>
          </blockquote>
          <p className="leading-relaxed" style={{ color: 'var(--ink-soft)' }}>
            Formed in {site.foundedYear}, Pragati is among the oldest Bengali
            organizations on the East Coast — dedicated to honouring our shared
            heritage while welcoming every neighbour, friend, and stranger into
      ...
      <section className="mx-auto max-w-6xl px-5 py-12">
        <Reveal>
          <div
            ...
            style={{
              background:
                'linear-gradient(140deg, var(--sindoor) 0%, var(--sindoor-deep) 60%, #4a0510 100%)',
              boxShadow: 'var(--shadow)',
            }}
          >
            {/* floating petals inside the band */}
            <span
              className="petal-drop pale"
              style={{ left: '12%', animationDelay: '1s' }}
              aria-hidden
            />
            <span
              className="petal-drop pale"
            ...
            <div className="relative z-[2]">
              <p
                className="font-[family-name:var(--font-bangla)] text-2xl md:text-3xl mb-3"
                style={{ color: 'var(--marigold-bright)' }}
              >
                এসো, মায়ের আঙিনায় 🪔
              </p>
              <h2
                className="font-[family-name:var(--font-display)] text-3xl md:text-5xl font-black leading-tight"
                style={{ color: 'var(--cream)' }}
              >
                You&apos;re invited home.
              </h2>
              <p
                className="font-[family-name:var(--font-bangla)] mt-6 text-xl leading-relaxed max-w-lg"
                style={{ color: 'var(--marigold-pale)' }}
              >
                ঢাকের তালে, ভোগের গন্ধে, হাজার চেনা মুখের ভিড়ে — আপনার জন্য
                জায়গা রাখা আছে। আসছেন তো?
              </p>
              <p
                className="mt-3 text-lg leading-relaxed max-w-lg"
                style={{ color: 'var(--marigold-pale)' }}
              >
                The dhaak, the bhog, a thousand familiar faces — please come and
                join us.
              </p>
        ...
        <Reveal>
          <div className="flex items-end justify-between gap-6 flex-wrap mb-10">
            <div>
              <h2 className="font-[family-name:var(--font-display)] text-3xl md:text-[42px] font-black leading-tight">
                <span
                  className="font-[family-name:var(--font-bangla)] block text-xl font-normal mb-1"
                  style={{ color: 'var(--terracotta)' }}
                >
                  উৎসবের রাত
                </span>
                Festivals, food, music —{' '}
                <em style={{ color: 'var(--sindoor)' }}>together</em>.
              </h2>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-5 md:grid-rows-2">
          {featured && (
            <Reveal className="md:row-span-2 md:col-span-2">
              <Link
                ...
                className="event-card h-full min-h-[420px] block"
              >
                {featured.theme === 'durga' ? (
                  <div
                    className="img"
                    style={{
                      backgroundImage: 'url(/about/pandal-patachitra.jpg)',
                  ...
                  <div
                    className={`img ${featured.theme === 'kali' ? 'img-kali' : featured.theme === 'saraswati' ? 'img-saraswati' : 'img-durga'}`}
                  />
                )}
                ...
                <div className="relative z-[2] p-7 w-full">
                  ...
                  <h3
                    className="font-[family-name:var(--font-display)] text-3xl md:text-4xl font-black"
                    style={{
                      color: '#FBF6EC',
                  ...
                  >
                    {featured.nameBengali && (
                      <span
                        className="font-[family-name:var(--font-bangla)] block text-xl font-normal"
                        style={{ color: 'var(--marigold-pale)' }}
                      >
                        {featured.nameBengali}
                      </span>
                  ...
                  >
                    {featured.startsAt.toLocaleDateString('en-US', {
                      timeZone: 'America/New_York',
                      month: 'short',
                      day: 'numeric',
                    })}
                    –
                    {featured.endsAt.toLocaleDateString('en-US', {
                      timeZone: 'America/New_York',
                      day: 'numeric',
                    })}{' '}
                    · {featured.venueName}
          ...
          {others.map((e, i) => (
            <Reveal key={e.id} delay={0.08 * (i + 1)}>
              <Link
                href={`/events/${e.slug}`}
                className="event-card h-full block"
              >
                <div
                  className={`img ${e.theme === 'kali' ? 'img-kali' : e.theme === 'saraswati' ? 'img-saraswati' : CARD_GRADIENTS[(i + 3) % CARD_GRADIENTS.length]}`}
                />
                <div className="overlay" />
                <div className="arrow-circle">↗</div>
                <div className="relative z-[2] p-5 w-full">
                  <span className="chip">
                    {e.theme !== 'none' ? 'Pujo' : 'Community'}
                  </span>
                  <h3
                  ...
                  >
                    {e.nameBengali && (
                      <span
                        className="font-[family-name:var(--font-bangla)] block text-sm font-normal"
                        style={{ color: 'var(--marigold-pale)' }}
                      >
                        {e.nameBengali}
                      </span>
          ...
          {[
            ...
            },
            {
              theme: 'saraswati',
              img: 'img-saraswati',
              bn: 'সরস্বতী পূজা ২০২৭',
              name: 'Saraswati Pujo 2027',
              chip: 'Vasant Panchami',
            },
          ]
            .filter(
              (t) =>
                featured?.theme !== t.theme &&
                !others.some((e) => e.theme === t.theme),
            )
            .map((t, i) => (
              <Reveal key={t.theme} delay={0.1 + i * 0.08}>
                <div
                  className="event-card h-full min-h-[200px]"
      ...
      <section className="mx-auto max-w-6xl px-5 py-20 grid md:grid-cols-[auto_1fr] gap-16 items-center">
        ...
        <Reveal delay={0.12}>
          ...
          <h2 className="font-[family-name:var(--font-display)] text-3xl md:text-[42px] font-black leading-tight">
            ...
            Voices of our community, in{' '}
            <em style={{ color: 'var(--sindoor)' }}>print</em>.
          </h2>
          <p
            className="mt-5 leading-relaxed max-w-xl"
            style={{ color: 'var(--ink-soft)' }}
          >
            Every year, Pragati publishes a curated magazine of essays, poetry,
            recipes, art, and reflections from our members — preserving Bengali
            voices across generations and oceans.{' '}
            {magazines.length > 0
      ...
      <Reveal>
        <div className="shloka">
          ...
          <p className="translit">
            Aschhe bochhor abar hobe — next year, again, we will meet
          </p>
      ...
      <section className="relative overflow-hidden py-16">
        {['5%', '20%', '35%', '55%', '70%', '85%'].map((left, i) => (
          <span
            key={left}
            className="speck"
            style={{ left, animationDelay: `${i * 1.1}s` }}
            aria-hidden
          />
        ))}
        <div className="mx-auto max-w-6xl px-5 grid md:grid-cols-[1.1fr_0.9fr] gap-14 items-center relative z-[2]">
          <Reveal>
            ...
            <h2 className="font-[family-name:var(--font-display)] text-3xl md:text-[44px] font-black leading-tight">
              ...
              Become part of <em style={{ color: 'var(--sindoor)' }}>home</em> —
              away from home.
            </h2>
            <p
              ...
              style={{ color: 'var(--ink-soft)' }}
            >
              Pragati&apos;s annual membership unlocks member pricing on every
              event, our yearly magazine, the summer picnic, eligibility for
              Executive Committee positions, and a real sense of belonging.
            </p>
          </Reveal>
          <Reveal delay={0.12}>
            <div
              className="festive-card relative p-8"
              style={{ boxShadow: 'var(--shadow)' }}
            >
              <p
                className="font-[family-name:var(--font-display)] text-6xl font-black"
                style={{ color: 'var(--sindoor)' }}
              >
              ...
              <p className="text-sm mt-1" style={{ color: 'var(--ink-soft)' }}>
                <span className="font-[family-name:var(--font-bangla)]">
                  প্রতি পরিবার, প্রতি বছর
                </span>{' '}
                · per family · per year
              </p>
              <ul className="mt-6 grid gap-2.5 text-sm">
                {[
                  'Member pricing on every event during registration',
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <Reveal>
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, var(--terracotta) 0%, var(--sindoor) 100%)',
              boxShadow: 'var(--shadow)',
            }}
          >
            <p
              className="font-[family-name:var(--font-bangla)] text-2xl mb-3 opacity-90"
              style={{ color: 'var(--cream)' }}
            >
              আপনার আশীর্বাদে
            </p>
